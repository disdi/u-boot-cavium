...
/**
 * Converts a time in ns and clock period to the number of clock ccles.
 * @param time - time in ns, -1 for maximum
 * @param clock_period - clock period in ps.  Calculated as 1000000/MHz
 * @param max - maximum number of clock cycles, usually 0x3f
 *
