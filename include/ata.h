...
#define ATA_IO_DATA_FLAG    (0x100)
#define ATA_IO_REG_FLAG     (0x200)
#define ATA_IO_ALT_FLAG     (0x400)

#define ATA_IO_DATA(x)	(ATA_IO_DATA_FLAG+((x) * CONFIG_SYS_ATA_STRIDE))
#define ATA_IO_REG(x)	(ATA_IO_REG_FLAG +((x) * CONFIG_SYS_ATA_STRIDE))
#define ATA_IO_ALT(x)	(ATA_IO_ALT_FLAG +((x) * CONFIG_SYS_ATA_STRIDE))
#endif
/*
...
#define ATA_CMD_RD_DMA_EXT	0x25	/* Read DMA LBA48 (with retries) */
#define ATA_CMD_WRITE_EXT	0x34	/* Write Sectores (with retries) with 48bit addressing */
#define ATA_CMD_WR_DMA_EXT	0x35	/* Write DMA LBA48 (with retries) */
