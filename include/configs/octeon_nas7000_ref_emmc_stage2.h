 ...
 * the Octeon NAS7000 reference board booting from eMMC.
 */

#ifndef __CONFIG_H__
#define __CONFIG_H__

#define CONFIG_OCTEON_NAS7000_REF_MAJOR		1
#define CONFIG_OCTEON_NAS7000_REF_MINOR		0
...
#define OCTEON_NAS7000_REF_DEF_DRAM_FREQ	666
 ...
 */
/** Enable saveenv command */
#define CONFIG_CMD_SAVEENV
/** MMC device used to store the environment */
#define CONFIG_SYS_MMC_ENV_DEV		0
/** Offset of environment is just before the first partition */
#define CONFIG_ENV_OFFSET		0x0fc000
/** Environment is stored in the MMC device */
...
#include "octeon_nas7000_ref_shared.h"
#endif	/* __CONFIG_H__ */
