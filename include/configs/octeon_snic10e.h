...
/* The snic10e board does not have a MCU */
#define BOARD_MCU_AVAILABLE		0

#define CONFIG_SYS_I2C_EEPROM_ADDR	OCTEON_SNIC10E_BOARD_EEPROM_TWSI_ADDR
...
/**
 * The PCA9554A device is basically compatible with the CONFIG_PCA953X
 */
#define CONFIG_PCA953X
/**
 * Address of PCA9554A device
 */
#define CONFIG_SYS_I2C_PCA953X_ADDR	0x20
/**
 * TWSI bus for PCA9554A
 */
#define CONFIG_SYS_I2C_PCA953X_BUS	1

/**
 * Enable command to control pins on PCA9554A GPIO controller
 */
...
/* Vitesse VCS8488 tuning support */
...
#include "octeon_snic10e_shared.h"
