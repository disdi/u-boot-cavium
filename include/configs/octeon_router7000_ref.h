...
#define CONFIG_OCTEON_ROUTER7000_REF_MINOR		1
/*
...
/** The CN70XX has two TWSI buses and the ROUTER7000 Ref board uses both */
...
#define ROUTER7000_REF_DEF_DRAM_FREQ	500
...
/* SPI NOR flash support - disabled since it is not populated. */
#if 0
#define CONFIG_SF_DEFAULT_BUS		0	/** Default SPI bus	*/
#define CONFIG_SF_DEFAULT_CS		0	/** Default SPI chip select */
#define CONFIG_SF_DEFAULT_SPEED		50000000/** Default SPI speed	*/
...
#define CONFIG_SYS_I2C_PCA953X_ADDR	0x27
#define CONFIG_SYS_I2C_PCA953X_BUS      1
#define CONFIG_SYS_I2C_PCA953X_WIDTH	{ 0x27, 1, 16 }
