...
/* CONFIG_OCTEON_NIC210NVG set by Makefile in include/config.h */

/* Default DDR clock if tuple doesn't exist in EEPROM */
#define NIC210NVG_DEF_DRAM_FREQ		533
...
#define CONFIG_SYS_I2C_EEPROM_ADDR	OCTEON_NIC210NVG_BOARD_EEPROM_TWSI_ADDR
...
#define MTDPARTS_DEFAULT				\
	"mtdparts=octeon_nor0:1536k(bootloader)ro,"	\
	"2432k(storage),"				\
	"128k(environment)ro;"				\
...
#include "octeon_nic210nvg_shared.h"
...
#define OCTEON_NIC210NVG_CN63XX_DFM_ODT_CONFIGURATION \
    /* RANKS   reserved  WODT_MASK                LMCX_MODEREG_PARAMS1            RODT_CTL    RODT_MASK    reserved */ \
    /* =====   ======== ============== ========================================== ========= ============== ======== */ \
    /*   1 */ {   0,    0x00000001ULL, OCTEON_NIC210NVG_MODEREG_PARAMS1_1RANK_1SLOT,    5,     0x00000000ULL,  0  },     \
    /*   2 */ {   0,    0x00000101ULL, OCTEON_NIC210NVG_MODEREG_PARAMS1_2RANK_1SLOT,    5,     0x00000000ULL,  0  }

#define OCTEON_CN63XX_DFM_ODT_CONFIGURATION OCTEON_NIC210NVG_CN63XX_DFM_ODT_CONFIGURATION
