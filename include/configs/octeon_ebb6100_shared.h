#ifndef __OCTEON_EBB6100_SHARED_H__
#define __OCTEON_EBB6100_SHARED_H__
...
#define OCTEON_EBB6100_DRAM_SOCKET_CONFIGURATION0 \
    {{0x00, 0x00}, {EBB6100_spd_values, NULL}},{{0x00, 0x0}, {NULL, NULL}}
#else
#define OCTEON_EBB6100_DRAM_SOCKET_CONFIGURATION0 \
...
#define OCTEON_EBB6100_BOARD_EEPROM_TWSI_ADDR        (0x56)
...
#define OCTEON_EBB6100_MODEREG_PARAMS1_1RANK_1SLOT      \
    { .cn61xx = { .pasr_00      = 0,                    \
                  .asr_00       = 0,                    \
                  .srt_00       = 0,                    \
                  .rtt_wr_00    = 0,                    \
...
#define OCTEON_EBB6100_MODEREG_PARAMS1_1RANK_2SLOT      \
    { .cn61xx = { .pasr_00      = 0,                    \
                  .asr_00       = 0,                    \
                  .srt_00       = 0,                    \
...
#define OCTEON_EBB6100_MODEREG_PARAMS1_2RANK_1SLOT      \
    { .cn61xx = { .pasr_00      = 0,                    \
                  .asr_00       = 0,                    \
                  .srt_00       = 0,                    \
                  .rtt_wr_00    = 0,                    \
 ...
 /* Some 2-rank dimms work better in the EBB6100 board using 20 ohms
    for rtt_nom_01/11 at 1333 DDR */
#define OCTEON_EBB6100_MODEREG_PARAMS1_2RANK_2SLOT      \
    { .cn61xx = { .pasr_00      = 0,                    \
                  .asr_00       = 0,                    \
                  .srt_00       = 0,                    \
                  .rtt_wr_00    = 0,                    \
...
#define OCTEON_EBB6100_MODEREG_PARAMS1_4RANK_1SLOT      \
    { .cn61xx = { .pasr_00      = 0,                    \
                  .asr_00       = 0,                    \
                  .srt_00       = 0,                    \
                  .rtt_wr_00    = rttwr_120ohm,         \
...
#define OCTEON_EBB6100_CN61XX_DRAM_ODT_1RANK_CONFIGURATION \
    /* DIMMS   reserved  WODT_MASK                LMCX_MODEREG_PARAMS1             reserved       RODT_CTL    RODT_MASK    reserved */ \
    /* =====   ======== ============== ==========================================  ============== ========= ============== ======== */ \
    /*   1 */ {   0,    0x00000001ULL, OCTEON_EBB6100_MODEREG_PARAMS1_1RANK_1SLOT, {.u64=0x0000},     3,     0x00000000ULL,  0  },      \
    /*   2 */ {   0,    0x00050005ULL, OCTEON_EBB6100_MODEREG_PARAMS1_1RANK_2SLOT, {.u64=0x0000},     3,     0x00010004ULL,  0  }

#define OCTEON_EBB6100_CN61XX_DRAM_ODT_2RANK_CONFIGURATION \
    /* DIMMS   reserved  WODT_MASK                LMCX_MODEREG_PARAMS1             reserved       RODT_CTL    RODT_MASK    reserved */ \
    /* =====   ======== ============== ==========================================  ============== ========= ============== ======== */ \
    /*   1 */ {   0,    0x00000101ULL, OCTEON_EBB6100_MODEREG_PARAMS1_2RANK_1SLOT, {.u64=0x0000},     4,     0x00000000ULL,    0  },    \
    /*   2 */ {   0,    0x09090606ULL, OCTEON_EBB6100_MODEREG_PARAMS1_2RANK_2SLOT, {.u64=0x0000},     4,     0x01010404ULL,    0  }

#define OCTEON_EBB6100_CN61XX_DRAM_ODT_4RANK_CONFIGURATION \
    /* DIMMS   reserved  WODT_MASK                LMCX_MODEREG_PARAMS1             reserved       RODT_CTL    RODT_MASK    reserved */ \
    /* =====   ======== ============== ==========================================  ============== ========= ============== ======== */ \
    /*   1 */ {   0,    0x01030203ULL, OCTEON_EBB6100_MODEREG_PARAMS1_4RANK_1SLOT, {.u64=0x0000},     3,     0x01010202ULL,    0  }
...
#define OCTEON_EBB6100_DDR_CONFIGURATION                                \
    /* Interface 0 */                                                   \
    {                                                                   \
        .custom_lmc_config = {                                          \
            .min_rtt_nom_idx	= 2,                                    \
            ...
            .dll_read_offset    = {-13,-13,-13,-13,-13,-13,-13,-13,-13}, \
            .parity		= 0,                                    \
            .mode32b		= 0},                                   \
            .dimm_config_table = {                                      \
            OCTEON_EBB6100_DRAM_SOCKET_CONFIGURATION0,                  \
            ...
            .lmc_delay_dq = 0},                                         \
                           .odt_1rank_config = {                        \
            OCTEON_EBB6100_CN61XX_DRAM_ODT_1RANK_CONFIGURATION},        \
                                .odt_2rank_config = {                   \
            OCTEON_EBB6100_CN61XX_DRAM_ODT_2RANK_CONFIGURATION},        \
                                     .odt_4rank_config = {              \
            OCTEON_EBB6100_CN61XX_DRAM_ODT_4RANK_CONFIGURATION}         \
    }

#endif   /* __OCTEON_EBB6100_SHARED_H__ */
