...
#define MT18ASF1G72AZ_2G1AYESZG_VALUES \
...
#define MT18ASF1G72AZ_2G1AXESZG_VALUES \
...
/* MT18ASF1G72AZ_2G1AYESZG_VALUES       ID: 101   DDR4 */
/* MT18ASF1G72AZ_2G1AXESZG_VALUES       ID: 102   DDR4 */

/*-------------------------------------------------------------------*/
/* Configuration 0: gpio 1 = OFF */
/*-------------------------------------------------------------------*/
/* Select SPD from the list. */
#define OCTEON_EBB7804_CFG0_SPD_VALUES	MT18ASF1G72AZ_2G1AXESZG_VALUES
...
/*-------------------------------------------------------------------*/
/* Select SPD from the list. */
#define OCTEON_EBB7804_CFG1_SPD_VALUES	MT18ASF1G72AZ_2G1AYESZG_VALUES
...
{							\
	.cn78xx = {					\
		.rtt_park_00    = ddr4_rttpark_34ohm,	\
		.vref_value_00  = 0x1f,			\
		.vref_range_00  = 0,			\
		.rtt_park_01    = 0,			\
		.vref_value_01  = 0,			\
		.vref_range_01  = 0,			\
		.rtt_park_10    = ddr4_rttpark_34ohm,	\
		.vref_value_10  = 0,			\
		.vref_range_10  = 0,			\
		.rtt_park_11    = 0,			\
		.vref_value_11  = 0,			\
...
{							\
	.cn78xx = {					\
		...
		.vref_value_00  = 0x19,			\
		.vref_range_00  = 0,			\
		.rtt_park_01    = ddr4_rttpark_40ohm,	\
		.vref_value_01  = 0x19,			\
		.vref_range_01  = 0,			\
		.rtt_park_10    = 0,			\
		.vref_value_10  = 0,			\
...
{							\
	.cn78xx = {					\
		...
		.vref_value_01  = 0x19,			\
		.vref_range_01  = 0,			\
		.rtt_park_10    = ddr4_rttpark_80ohm,	\
		.vref_value_10  = 0x19,			\
		.vref_range_10  = 0,			\
		.rtt_park_11    = ddr4_rttpark_80ohm,	\
		.vref_value_11  = 0x19,			\
		.vref_range_11  = 0			\
	}						\
}
...
#define OCTEON_EBB7804_CN78XX_DRAM_ODT_1RANK_CONFIGURATION \
    ...
    /* =====   ======== ============== ==========================================  ========================================== ======== ============== ====== */ \
    /*   1 */ {   5,    0x00000001ULL, OCTEON_EBB7804_MODEREG_PARAMS1_1RANK_1SLOT, OCTEON_EBB7804_MODEREG_PARAMS2_1RANK_1SLOT,   7,    0x00000000ULL,    0  }, \
    /*   2 */ {   4,    0x00000000ULL, OCTEON_EBB7804_MODEREG_PARAMS1_1RANK_2SLOT, OCTEON_EBB7804_MODEREG_PARAMS2_1RANK_2SLOT,   7,    0x00040001ULL,    0  }

#define OCTEON_EBB7804_CN78XX_DRAM_ODT_2RANK_CONFIGURATION \
    /* DIMMS    DQX_CTL  WODT_MASK                LMCX_MODEREG_PARAMS1                        LMCX_MODEREG_PARAMS2            RODT_CTL   RODT_MASK    rsv'ed */ \
    /* =====   ======== ============== ==========================================  ========================================== ======== ============== ====== */ \
    /*   1 */ {   5,    0x00000201ULL, OCTEON_EBB7804_MODEREG_PARAMS1_2RANK_1SLOT, OCTEON_EBB7804_MODEREG_PARAMS2_2RANK_1SLOT,   7,    0x00000000ULL,    0  }, \
    /*   2 */ {   4,    0x0c0c0303ULL, OCTEON_EBB7804_MODEREG_PARAMS1_2RANK_2SLOT, OCTEON_EBB7804_MODEREG_PARAMS2_2RANK_2SLOT,   7,    0x04080102ULL,    0  }

#define OCTEON_EBB7804_CN78XX_DRAM_ODT_4RANK_CONFIGURATION \
    /* DIMMS    DQX_CTL  WODT_MASK                LMCX_MODEREG_PARAMS1                        LMCX_MODEREG_PARAMS2            RODT_CTL   RODT_MASK    rsv'ed */ \
    /* =====   ======== ============== ==========================================  ========================================== ======== ============== ====== */ \
    /*   1 */ {   4,    0x01030203ULL, OCTEON_EBB7804_MODEREG_PARAMS1_4RANK_1SLOT, OCTEON_EBB7804_MODEREG_PARAMS2_4RANK_1SLOT,   7,    0x01010202ULL,    0  }
