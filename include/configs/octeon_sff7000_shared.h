#ifndef __OCTEON_SFF7000_SHARED_H__
...
#define OCTEON_SFF7000_4GB_DRAM_SOCKET_CONFIGURATION0 \
	{{0x0, 0x0}, {octeon_sff7000_4gb_spd_values, NULL}}

#define OCTEON_SFF7000_BOARD_EEPROM_TWSI_ADDR	(0x54)
 ...
 *
 */
#define OCTEON_SFF7000_MODEREG_PARAMS1_1RANK_1SLOT	\
{							\
	.cn63xx = {					\
		.pasr_00	= 0,			\
		.asr_00		= 0,			\
...
#define OCTEON_SFF7000_MODEREG_PARAMS1_2RANK_1SLOT	\
{							\
	.cn63xx = {					\
		.pasr_00	= 0,			\
		.asr_00		= 0,			\
...
#define OCTEON_SFF7000_DRAM_ODT_1RANK_CONFIGURATION \
	/* DIMMS   reserved  WODT_MASK                LMCX_MODEREG_PARAMS1             reserved       RODT_CTL    RODT_MASK    reserved */	\
	/* =====   ======== ============== ==========================================  ============== ========= ============== ======== */	\
	/*   1 */ {   0,    0x00000001ULL, OCTEON_SFF7000_MODEREG_PARAMS1_1RANK_1SLOT, {.u64=0x0000},     3,     0x00000000ULL,  0  }	\

#define OCTEON_SFF7000_DRAM_ODT_2RANK_CONFIGURATION \
	/* DIMMS   reserved  WODT_MASK                LMCX_MODEREG_PARAMS1             reserved       RODT_CTL    RODT_MASK    reserved */	\
	/* =====   ======== ============== ==========================================  ============== ========= ============== ======== */	\
	/*   1 */ {   0,    0x00000101ULL, OCTEON_SFF7000_MODEREG_PARAMS1_2RANK_1SLOT, {.u64=0x0000},     3,     0x00000000ULL,    0  }    \
...
#define OCTEON_SFF7000_4GB_DDR_CONFIGURATION {				\
	/* Interface 0 */						\
	.custom_lmc_config = {						\
		.min_rtt_nom_idx	= 1,				\
		.max_rtt_nom_idx	= 5,				\
        ...
        .dimm_config_table = {						\
		OCTEON_SFF7000_4GB_DRAM_SOCKET_CONFIGURATION0,		\
	...
	.odt_1rank_config = {                        			\
		OCTEON_SFF7000_DRAM_ODT_1RANK_CONFIGURATION,		\
	},								\
	.odt_2rank_config = {						\
		OCTEON_SFF7000_DRAM_ODT_2RANK_CONFIGURATION,		\
	},								\
}
#endif   /* __OCTEON_SFF7000_SHARED_H__ */
