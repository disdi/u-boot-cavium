 ...
 * Octeon EAP7000-10G board.
 */

#ifndef __CONFIG_H__
#define __CONFIG_H__

#define CONFIG_OCTEON_EAP7000_10G_MAJOR		1
#define CONFIG_OCTEON_EAP7000_10G_MINOR		0
/*
...
/** The CN70XX has two TWSI buses and the EAP7000 10G board uses only bus 0 */
#define CONFIG_SYS_MAX_I2C_BUS		0

#include "octeon_common.h"

/* Default DDR clock if tuple doesn't exist in EEPROM */
#define EAP7000_10G_DEF_DRAM_FREQ	500
...
#define CONFIG_SYS_I2C_EEPROM_ADDR	OCTEON_EAP7000_10G_BOARD_EEPROM_TWSI_ADDR
...
#include "octeon_eap7000_10g_shared.h"
